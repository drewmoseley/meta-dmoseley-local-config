...
SRC_URI = "git://gitlab.com/steady-equipment-corporation/poursteady-wifi-connect.git;protocol=https;branch=dunfell"
SRCREV="72e90b7ee5082eb3403dc0d5d1b8e16f9d4b3a08"
...
do_install_append () {
    ...
    # Install custom UDEV rules to run wifi-connect when the device is available
