...
IMAGE_BOOT_FILES_remove_imx6ul-var-dart = "${@bb.utils.contains("DMOSELEY_FEATURES", "dmoseley-mender", "${KERNEL_IMAGETYPE} ${KERNEL_DEVICETREE}", "", d)}"
...
IMAGE_BOOT_FILES_remove_imx8mm-var-dart = "${@bb.utils.contains("DMOSELEY_FEATURES", "dmoseley-mender", "${KERNEL_IMAGETYPE} ${KERNEL_DEVICETREE}", "", d)}"
...
IMAGE_BOOT_FILES_remove_imx8mn-var-som = "${@bb.utils.contains("DMOSELEY_FEATURES", "dmoseley-mender", "${KERNEL_IMAGETYPE} ${KERNEL_DEVICETREE}", "", d)}"
...
MACHINE_EXTRA_RDEPENDS_remove_variscite = "${@bb.utils.contains("DMOSELEY_FEATURES", "dmoseley-mender", "", "u-boot-fw-utils", d)}"
